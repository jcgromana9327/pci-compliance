...
/* ##################################################################################### */
    ...
    sleep(5);
    $year = "#ymm_year > option:nth-child(13)";
    $year = $this->byCssSelector($year);
    $year->click();
    sleep(2);
    $make = "#ymm_make > option:nth-child(12)";
    $make = $this->byCssSelector($make);
    $make->click();
    sleep(2);
    $model = "#ymm_model > option:nth-child(11)";
    $model = $this->byCssSelector($model);
    $model->click();
    sleep(2);
    $submodel = "#ymm_submodel > option:nth-child(2)";
    $submodel = $this->byCssSelector($submodel);
    $submodel->click();
    ...
    sleep(7);
     ...
     $elementButton->click();
     $currentUrl = $this->url();
     $partname = str_replace("http://preprod.partstrain.staging.usautoparts.com/store/?N=0&src=search&Ntt=", "", $currentUrl);
     $this->serp($partname);
    }
      ...
      // sleep(5);
       ...
       public function cart(){
          // sleep(2);
           $urlMain = "http://preprod.partstrain.staging.usautoparts.com/store/?N=0&src=search&Ntt=";
           $urlArr = array(
...
//120
           ...
           $itemCount = $this->elements($this->using('css selector')->value('#CartLineItem table tbody > tr:not(.cpp)'));
