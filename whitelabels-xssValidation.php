...
class MySeleniumSuite extends PHPUnit_Extensions_Selenium2TestCase {
    ...
    public function setUp(){
        ...
        // $this -> filename = __DIR__ . "/reports/cpo-xss-injection-result.html";
        // $this -> filename = __DIR__ . "/reports/ca.cp-xss-injection-result.html";
        // $this -> filename = __DIR__ . "/reports/ca.jcw-xss-injection-result.html";
        $this -> filename = __DIR__ . "/reports/ca.apw-xss-injection-result.html";

        $this -> fp = fopen($this -> filename, 'w');
        $data = 'Origin environment: ' . $this -> configEnvironment["origin"] .$this -> templateHeader["xss-header"];
        fwrite($this->fp, $data);
    }
